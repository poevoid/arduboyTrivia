...
const uint8_t LEFTTITLE[] PROGMEM = {
  8, 8,
...
const uint8_t BTITLE[] PROGMEM = {
  8, 8, 
0x3C,0x7E,0x81,0xA5,0xA5,0x89,0x7E,0x3C,
...
const static char q2ansDOWN[] PROGMEM = {"Dick pics & roast beef \n sandwhiches"};
...
const static char q3ansUP[] PROGMEM = {"Nothing. I don't touch\n YOUR shit. You don't\n touch MY shit."};
const static char q3ansLEFT[] PROGMEM = {"Depends if hungry. \nOr sleepy.\n"}; //true
...
const static char question5[] PROGMEM ={"Who killed \n Maureen Ponderosa?"};
...
const static char question9[] PROGMEM ={"Which horrible thing did \npsycho Pete actually do?"};
...
const static char question10[] PROGMEM ={"Where's the best place\n to stash your drugs?"};
...
const static char question11[] PROGMEM ={"What is charlie's \n'Bad Place'?"};
...
const static char question12[] PROGMEM ={"According to Frank, what\n is 'Bird Watching'?"};
...
const static char question14[] PROGMEM = {"How do you get away from \nGail the Snail?"};
...
const static char question15[] PROGMEM ={"Why does Dennnis hate \nValentine's day?"};
...
const static char question16[] PROGMEM ={"What are charlie's color\n rituals for sports games?"};
